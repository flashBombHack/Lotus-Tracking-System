...
//export const API_BASE_URL = 'http://localhost:3033/api';
export const API_BASE_URL = 'https://automationapi.lotuscapitallimited.com/api';
...
export const GETUSERSBYID_ENDPOINT = `${API_BASE_URL}/user/getuserbyID`;
...
// 1:  Tracking system Module


export const UPLOADANDMERGEPDF_ENDPOINT = `${API_BASE_URL}/app/uploadAndMergePDF`;
export const UPDATEAPPROVALSTATUS_ENDPOINT = `${API_BASE_URL}/app/updateApprovalStatus`;
export const DELETEAPPROVER_ENDPOINT = `${API_BASE_URL}/app/deleteUser`;
export const GETTRANSACTIONCOUNT_ENDPOINT = `${API_BASE_URL}/app/gettransactioncounts`;
export const ADDAPPROVER_ENDPOINT = `${API_BASE_URL}/app/addUsers`;
export const GETAPPROVER_ENDPOINT = `${API_BASE_URL}/app/getUsers`;
export const GETPOSTEDTRANSACTIONS_ENDPOINT = `${API_BASE_URL}/app/getpostedtransactions`;
export const GETCOMPLETEDTRANSACTIONS_ENDPOINT = `${API_BASE_URL}/app/getcompletedtransactions`;
export const GETUSERSETTINGS_ENDPOINT = `${API_BASE_URL}/app/getUserSettings`;
export const UPDATEUSERSETTINGS_ENDPOINT = `${API_BASE_URL}/app/updateUserSettings`;
export const GETINVESTMENTPRODUCT_ENDPOINT = `${API_BASE_URL}/app/getInvestmentProducts`;
export const COMPLETETRANSACTION_ENDPOINT = `${API_BASE_URL}/app/completeApprovalStatus`;
export const FAILTRANSACTION_ENDPOINT = `${API_BASE_URL}/app/uploadAndMergePDF`;
export const GETALLTRANSACTIONS_ENDPOINT = `${API_BASE_URL}/app/getAlltransactions`;
export const BULKAPPROVAL_ENDPOINT = `${API_BASE_URL}/app/bulkApproval`;
export const GETTRANSACTIONBYDATE_ENDPOINT = `${API_BASE_URL}/app/getcompletedtransactionsByDate`;
export const GETATTACHMENT_ENDPOINT = `${API_BASE_URL}/app/getattachmentbyrequestno`;
